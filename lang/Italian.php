...
define('JS_LANG_ReloadFolders', 'Ricarica lista cartelle');
...
define('JS_LANG_AddSignatures', 'Aggiungi firma a tutti i messaggi in uscita');
define('JS_LANG_DontAddToReplies', 'Non aggiungere firma ai messaggi di risposta e ai messaggi inoltrati');
...
define('JS_LANG_OnMailServer', 'Crea questa Cartella nella webmail e all\'interno del Server');
define('JS_LANG_InWebMail', 'Crea questa cartella SOLO nella webmail');
...
define('Title_CheckSharedCalendars', 'Verifica calendari condivisi');

<?php
// Danish translation by Mike Johnsen/Jeppe Richardt
// Last edited 04-08-2010: JR
...
define('RegEmailDesc', 'Fx., mitnavn@domæne.dk. Denne information blive blive brugt til at logge ind i systemet.');
...
define('AttachmentPending', 'Afventer...');
define('AttachmentUploading', 'Uploader...');
define('AttachmentComplete', 'Udført.');
define('AttachmentCancelled', 'Annulleret.');
define('AttachmentStopped', 'Stoppet.');
define('AttachmentsUpload', 'Vedhæft filer');
...
define('MobileSyncCalendarDataBaseTitle', 'Mobil sync kalender database');

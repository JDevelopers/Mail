...
define('AttachmentPending', '待機中...');
define('AttachmentUploading', 'アップロード中...');
define('AttachmentComplete', '完了');
define('AttachmentCancelled', 'キャンセル.');
define('AttachmentStopped', '中止.');
define('AttachmentsUpload', 'ファイルの添付');

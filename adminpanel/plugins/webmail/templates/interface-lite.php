...
<?php $this->data->PrintValue('txtDefaultLanguage') ?>
	...
	<tr>
		<td align="right" >&nbsp;</td>
		<td>
			<input type="checkbox" class="wm_checkbox" name="intAllowCalendar" id="intAllowCalendar" value="1" disabled="disabled" />
			&nbsp;<label for="intAllowCalendar"><font color="#aaaaaa">Allow calendar (Pro only)</font></label>
		</td>
	</tr>
	...
	<tr class="<?php $this->data->PrintInputValue('classSaveInSent') ?>">
		...
		<td>
			<select style="width: 150px;" class="wm_input" name="selSaveInSent">
				<option value="0" <?php $this->data->PrintSelectedValue('SaveInSentAlways') ?> >Always</option>
				<option value="1" <?php $this->data->PrintSelectedValue('SaveInSentOn') ?> >Default=On</option>
				<option value="2" <?php $this->data->PrintSelectedValue('SaveInSentOff') ?>>Default=Off</option>
			</select>
		</td>
	</tr>

...
define('JS_LANG_ReloadFolders', '刷新文件夹');
...
define('JS_LANG_AddSignatures', '发邮件时添加签名');
define('JS_LANG_DontAddToReplies', '回复、转发时不添加签名');
...
define('JS_LANG_OnMailServer', '在WebMail和服务器创建此文件夹');
define('JS_LANG_InWebMail', '仅在WebMail创建此文件夹');
...
define('Title_CheckSharedCalendars', '检查分享日程表');

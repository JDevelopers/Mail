...
define('JS_LANG_ReloadFolders', 'Recargar Arbol Carpetas');
...
define('JS_LANG_AddSignatures', 'Agregar firma a todos los mensajes salientes');
define('JS_LANG_DontAddToReplies', 'No Agregar firma al responder o reenviar');
...
define('JS_LANG_OnMailServer', 'Crear esta Carpeta solo en WebMail y en Servidor');
define('JS_LANG_InWebMail', 'Crear esta Carpeta solo en WebMail');
...
define('Title_CheckSharedCalendars', 'Buscar Calendarios Compartidos');

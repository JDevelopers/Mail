...
define('JS_LANG_ReloadFolders', '刷新文件夾');
...
define('JS_LANG_AddSignatures', '發郵件時添加簽名');

define('JS_LANG_DontAddToReplies', '回複、轉發時不添加簽名');
...
define('JS_LANG_OnMailServer', '在WebMail和服務器創建此文件夾');
define('JS_LANG_InWebMail', '僅在WebMail創建此文件夾');
...
define('Title_CheckSharedCalendars', '檢查分享日程表');

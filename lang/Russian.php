...
define('AttachmentPending', 'Ожидается...');
define('AttachmentUploading', 'Загружается...');
define('AttachmentComplete', 'Готово.');
define('AttachmentCancelled', 'Отменено.');
define('AttachmentStopped', 'Остановлено.');
define('AttachmentsUpload', 'Загрузка аттачментов');
define('AttachmentsUploadPadding', '1');

define('TestButton', 'ТЕСТ');
define('AutoCheckMailIntervalLabel', 'Автоматическая проверка');
...
define('SwitchToFullForm', 'Открыть в большом окне');

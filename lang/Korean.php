...
define('JS_LANG_ReloadFolders', '메일함 새로고침');
...
define('JS_LANG_AddSignatures', '보내는 모든 메일에 서명 넣기');
define('JS_LANG_DontAddToReplies', '회신 및 전달 메일에 서명 넣지 않기');
...
define('JS_LANG_OnMailServer', '메일 서버 및 웹 메일에 현재 메일함 생성');
define('JS_LANG_InWebMail', '웹 메일에만 현재 메일함 생성');
...
define('Title_CheckSharedCalendars', '공유된 캘린더 확인');
...
define('AttachmentPending', '검토 중...');
define('AttachmentUploading', '업로드 중...');
define('AttachmentComplete', '완료.');
define('AttachmentCancelled', '취소.');
define('AttachmentStopped', '중지.');
define('AttachmentsUpload', '파일 첨부');
